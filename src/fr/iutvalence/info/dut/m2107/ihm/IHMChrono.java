/**
 * Classe de génération d'un chromnomètre.
 */
...
{	
		...
		public static void main(String[] args)
		{
			...
			/* Afficher l'ihm */
			fenetre.pack();
//			fenetre.setLocationRelativeTo(IHMSceance.jPanel0);
			fenetre.setLocation(490,610);  /* Déplacer la fenetre à ce nouvel emplacement */
